        ...
        <div class="am-tabs am-margin" data-am-tabs>
            ...
            <div class="am-tabs-bd">
                <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                    ...
                    <form class="am-form am-form-horizontal" id="information-form" action="${ctx}/user/${user.userid}/update" method="post" data-am-validator>
                ...
                <div class="am-tab-panel am-fade" id="tab2">
                    <form class="am-form am-form-horizontal" action="${ctx}/user/${userid}/upload" enctype="multipart/form-data" method="post" onsubmit="return checkFileType();" style="text-align: center;">
                ...
                <div class="am-tab-panel am-fade" id="tab3">
                    <form class="am-form am-form-horizontal" data-am-validator action="${ctx}/user/${userid}/pass" method="post">
                        <div class="am-form-group">
