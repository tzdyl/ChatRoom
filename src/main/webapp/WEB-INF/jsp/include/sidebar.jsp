...
<div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
        <ul class="am-list admin-sidebar-list">
            <li><a href="${ctx}/user/${userid}/chatPage"><span class="am-icon-commenting"></span> 聊天</a></li>
            <li><a href="${ctx}/user/${userid}/information" class="am-cf"><span class="am-icon-book"></span> 个人信息<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
            <li class="admin-parent">
                ...
                <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                    <li><a href="${ctx}/user/${userid}/editPage"><span class="am-icon-group"></span> 个人设置</a></li>
            ...
            <li><a href="${ctx}/logout"><span class="am-icon-sign-out"></span> 注销</a></li>
        </ul>
